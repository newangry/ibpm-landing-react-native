  ...
  <div className={styles.card}>
    ...
    <span style={{ marginTop: 16 }}>
      ...
      <ul style={{ paddingLeft: 16 }}>
        ...
        <li>
          <strong>Get your BPM:</strong> The app will display the exact tempo of
          the music, allowing you to sync with the beat with precision.
        </li>
        <li>
          <strong>Effortless workflow:</strong> iBPM seamlessly integrates with
          your music library and provides quick access to your tempo history.
        </li>
        <li>
      ...
      <br />
      Stop tapping and start feeling the rhythm with iBPM. Download today and
      unlock the power of effortless beat detection.
    </span>
    <Image
      src="/appstore.svg"
